...
var Engine = function () {
  ...
  _createClass(Engine, [{
    ...
    value: function generateProposal() {
      ...
      // Form input fields
      var input_fields = new Array('project-details-title', 'project-details-client-company-name', 'project-details-client-company-website', 'project-details-client-company-address', 'project-details-client-contact-name', 'project-details-client-contact-email');
      var data = {
      ...
      $.post('/proposal/new', data).always(function (response) {
