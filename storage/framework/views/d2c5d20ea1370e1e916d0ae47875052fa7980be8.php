        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="project-details-title" 
					value="<?php echo e($proposal->{'project-details-title'}); ?>" placeholder="">
            </div>
        </div>
            ...
            <div class="form-group">
				...
				<div class="btn-group selectlist" data-initialize="selectlist" style="width:100%;"> 
					...
					<ul class="dropdown-menu" role="menu" style="width:100%;">
						<li data-value="cto" 
							<?php if($proposal->{'project-details-type'} === 'cto'): ?> data-selected="true" <?php endif; ?>
							>
							<a href="#">CTO as a Service</a>
						</li>
						<li data-value="custom-project" 
							<?php if($proposal->{'project-details-type'} === 'custom-project'): ?> data-selected="true" <?php endif; ?>
							>
							<a href="#">Custom Project</a>
						</li>
					</ul>
					<input class="hidden hidden-field" id="project-details-type" name="project-details-type" 
						readonly="readonly" aria-hidden="true" type="text" value="<?php echo e($proposal->{'project-details-type'}); ?>"/>
				</div>
            </div>
        </div>
    </div>
        ...
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="project-details-client-company-name" 
					value="<?php echo e($proposal->{'project-details-client-company-name'}); ?>" placeholder="">
            </div>
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="project-details-client-company-website" 
					value="<?php echo e($proposal->{'project-details-client-company-website'}); ?>" placeholder="">
            </div>
            <div class="form-group">
                <label for="project-details-client-company-address">Company Address</label>
                <textarea class="form-control" rows="6" id="project-details-client-company-address" placeholder=""><?php echo e($proposal->{'project-details-client-company-address'}); ?></textarea>
            </div>
        ...
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="project-details-client-contact-name" 
					value="<?php echo e($proposal->{'project-details-client-contact-name'}); ?>" placeholder="">
            </div>
            <div class="form-group">
                ...
                <input type="email" class="form-control" id="project-details-client-contact-email" 
					value="<?php echo e($proposal->{'project-details-client-contact-email'}); ?>" placeholder="">
            </div>
