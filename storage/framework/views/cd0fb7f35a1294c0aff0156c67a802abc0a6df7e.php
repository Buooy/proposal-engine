<div class="step-pane" data-step="4">
	...
	<div class="row">
        <div class="col-md-12">
			<h4>Introduction</h4>
            <textarea id="project-scope-of-work-introduction" class="summernote" rows="5"><?php echo e($proposal->{'project-scope-of-work-introduction'}); ?></textarea>
        </div>
    </div>
	...
	<div class="row">
        <div class="col-md-12">
			<h4>End</h4>
            <textarea id="project-scope-of-work-end" class="summernote" rows="5"><?php echo e($proposal->{'project-scope-of-work-end'}); ?></textarea>
        </div>
    </div>
